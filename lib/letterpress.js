...
var getMovesForBoard = memoize(function(board, minFrequency) {
  ...
  console.log(wordStructs);
  var boardPositionMap = getBoardPositionMap(board);
  console.log("boardPositionMap" + JSON.stringify(boardPositionMap));
  var moves = [];
  _.each(wordStructs, function(w) {
    ...
    console.log("combos: " + JSON.stringify(posCombos));
    var flatCombos = flattenCombos(posCombos);
    console.log("flatCombos:" + JSON.stringify(flatCombos));
